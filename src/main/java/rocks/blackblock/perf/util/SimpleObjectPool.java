...
/**
 * A generic, fixed-size object pool implementation for efficient object reuse.
 * Provides thread-safe allocation and release of objects, with customizable
 * construction, initialization, and recycling behaviors.
 *
